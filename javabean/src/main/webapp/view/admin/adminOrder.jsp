...
<form name="frm" action="${pageContext.request.contextPath}/OrderSelectC">
<table border="1">
	<tr>
		<td>주문상태</td>
	...
	<tr><td colspan=3><input type="submit"  value="검색하기" /></td></tr>
</table>
</form>
<br>
<br>
...
<td>${ord.p_nxy}</td>
<td>${ord.d_nxczy}</td>
<td><a href="${pageContext.request.contextPath}/OrderModifyC?mid=${ord.mid}&oid=${ord.oid}">수정</a></td>
