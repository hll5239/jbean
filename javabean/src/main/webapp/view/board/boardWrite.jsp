...
<div>
<center>
<textarea class="form-control" name="bcontent" id="bcontent" required="" placeholder="내용을 입력 하세요." cols="100" rows="20"  maxlength="4000" style="width: 600px; height: 400px;" data-error=""></textarea>
